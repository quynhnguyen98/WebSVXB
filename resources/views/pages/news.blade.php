    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-1.jpg);"></div>
                <div class="text p-4">
            ...
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-2.jpg);"></div>
                <div class="text p-4">
            ...
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-3.jpg);"></div>
                <div class="text p-4">
            ...
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-4.jpg);"></div>
                <div class="text p-4">
            ...
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-5.jpg);"></div>
                <div class="text p-4">
            ...
            <div class="col-md-4 ministry ftco-animate">
                <div class="img"style="background-image: url(public/frontend/images/ministry-6.jpg);"></div>
                <div class="text p-4">
