  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Chào Admin của nhóm',
        // (string | mandatory) the text inside the notification
        text: 'Hy Vọng bạn sẽ luôn luôn thường xuyên cập nhật thông tin của chúng tôi, để mọi người có thể tìm hiểu về nhóm nhiều hơn nhé ^^ !!!',
        // (string | optional) the image to display on the left
        image: 'public/backend/img/logo.jpg',
